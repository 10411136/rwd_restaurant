  ...
  <div>
      ...
      <main class="l-main">
        ...
        <section class="home" id="home">
          <div class="home__container bd-container bd-grid">
            <div class="home__data">
              ...
              <h2 class="home__subtitle">Try the best food of <br> hte week.</h2>
              <a href="#" class="button">view menu</a>
            </div>
            <img src="@/static/home.png" class="home__img" alt="HOMEIMG">
          </div>
        </section>
        ...
        <section class="about section bd-container" id="about">
          <div class="about__container bd-grid">
            <div class="about__data">
              ...
              <h2 class="section-title">We cook the best tasty food</h2>
              ...
              <a href="#" class="button">Expore history</a>
            </div>
            <img src="@/static/about.jpg" alt="" class="about__img">
          </div>
        </section>
        ...
        <section class="services section bd-container" id="services">
          ...
          <h2 class="section-title">Our amazing serivces</h2>
        ...
        <section class="menu section bd-container" id="menu">
          ...
          <div class="menu__container bd-grid">
            <div class="menu__content">
              <img class="menu__img" src="@/static/plate1.png" alt="">
            ...
            <div class="menu__content">
              <img class="menu__img" src="@/static/plate2.png" alt="">
            ...
            <div class="menu__content">
              <img class="menu__img" src="@/static/plate3.png" alt="">
          ...
          <div class="app__container bd-grid">
            <div class="app__data">
              ...
              <div class="app__stores">
                <a href="#"><img class="app__store" src="@/static/app1.png" alt=""></a>
                <a href="#"><img class="app__store" src="@/static/app2.png" alt=""></a>
              </div>
            </div>
            <img class="app__img" src="@/static/movil-app.png" alt="">
          </div>
        </section>
        ...
        <section class="contact section bd-container" id="contact">
          <div class="contact__container bd-grid">
            <div class="contact__data">
              ...
              <p class="contact__description">If you want to reserve a table in our restaurant,  contact us we will attend you quickly, with our 24/7 chat service.</p>
            </div>
...
export default {
    ...
    methods:{
        ...
        scrollTop(){
            const srollTop = document.getElementById('scroll-top');
            if(window.scrollY >= 560)
                srollTop.classList.add('scroll-top');
            else
                srollTop.classList.remove('scroll-top');
        },
        scrollActive(){
